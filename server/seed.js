...
//
// Can be run directly:  node seed.js
// Or imported and called programmatically from server.js (auto-seed on
// first startup when the database is empty).
import bcrypt from 'bcryptjs';
import { rawDb, db } from './db/client.js';
import { users, medicines, claims, notifications } from './db/schema.js';
...
// If run directly (node seed.js), execute immediately.
// If imported by server.js, export the function to be called manually.
